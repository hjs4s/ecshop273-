...
<title>飞利浦9@9v_GSM手机_手机类型_ECSHOP演示站 - Powered by ECShop</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">手机类型</a> <code>&gt;</code> <a href="category.php?id=3">GSM手机</a> <code>&gt;</code> 飞利浦9@9v </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
...
<div class="box">
 <div class="box_1">
  ...
  <div class="boxCenterList RelaArticle">
        <a href="article.php?id=28" title="飞利浦9@9促销">飞利浦9@9促销</a><br />
      </div>
 </div>
</div>
<div class="blank5"></div>
<div class="box">
 <div class="box_1">
  ...
  <div class="boxCenterList clearfix">
    ...
    <ul class="clearfix">
      <li class="goodsimg">
      <a href="goods.php?id=17" target="_blank"><img src="images/200905/thumb_img/17_thumb_G_1241969394587.jpg" alt="" class="B_blue" /></a>
      </li>
      <li>
      <a href="goods.php?id=17" target="_blank" title="">夏新N7</a><br />
      本店售价：<font class="f1">￥2185元</font><br />
      </li>
    </ul>
    </div>
 </div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
          <a href="javascript:;" onclick="window.open('gallery.php?id=8'); return false;">
      <img src="images/200905/goods_img/8_G_1241425513055.jpg" alt="飞利浦9@9v"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=8&amp;img=10" target="_blank"><img src="images/200905/thumb_img/8_thumb_P_1241425513834.jpg" alt="飞利浦9@9v" class="B_blue" /></a>
            </li>
                        <li><a href="gallery.php?id=8&amp;img=11" target="_blank"><img src="images/200905/thumb_img/8_thumb_P_1241425891460.jpg" alt="飞利浦9@9v" class="B_blue" /></a>
            </li>
                        <li><a href="gallery.php?id=8&amp;img=12" target="_blank"><img src="images/200905/thumb_img/8_thumb_P_1241425892547.jpg" alt="飞利浦9@9v" class="B_blue" /></a>
            </li>
                        <li><a href="gallery.php?id=8&amp;img=13" target="_blank"><img src="images/200905/thumb_img/8_thumb_P_1241425892356.jpg" alt="飞利浦9@9v" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
     ...
     <div class="clearfix">
      <p class="f_l">飞利浦9@9v</p>
      <p class="f_r">
            <a href="goods.php?id=9"><img alt="prev" src="themes/default/images/up.gif" /></a>
                  </p>
      </div>
      <ul>
             <li class="clearfix">
       <dd>
              <strong>商品货号：</strong>ECS000008              </dd>
       <dd class="ddR">
                         <strong>商品库存：</strong>
          1 台                     </dd>
      </li>
      <li class="clearfix">
       <dd>
              <strong>商品品牌：</strong><a href="brand.php?id=4" >飞利浦</a>
              </dd>
       <dd class="ddR">
              <strong>商品重量：</strong>75克              </dd>
      </li>
      <li class="clearfix">
       <dd>
             <strong>上架时间：</strong>2009-05-04             </dd>
       <dd class="ddR">
      ...
      <li class="clearfix">
       <dd class="ddL">
              <strong>市场价格：</strong><font class="market">￥479元</font><br />
              
       <strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE">￥399元</font><br />
              <strong>注册用户：</strong><font class="shop" id="ECS_RANKPRICE_1">￥399元</font><br />
              <strong>vip：</strong><font class="shop" id="ECS_RANKPRICE_2">￥379元</font><br />
              </dd>
      ...
      <li class="padd">
      <a href="javascript:addToCart(8)"><img src="themes/default/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(8)"><img src="themes/default/images/bnt_colles.gif" /></a>
            <a href="user.php?act=affiliate&goodsid=8"><img src='themes/default/images/bnt_recommend.gif'></a>
            </li>
      </ul>
      </form>
     </div>
