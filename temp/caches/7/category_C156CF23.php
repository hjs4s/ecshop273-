  ...
  <div class="AreaR">
		 ...
		 <div class="box_1">
			<h3><span>商品筛选</span></h3>
			  ...
			  <strong>品牌：</strong>
														<span>全部</span>
																			<a href="category.php?id=5&amp;brand=1&amp;price_min=300&amp;price_max=1000">诺基亚</a>&nbsp;
																			<a href="category.php?id=5&amp;brand=4&amp;price_min=300&amp;price_max=1000">飞利浦</a>&nbsp;
												</div>
									<div class="screeBox">
			<strong>价格：</strong>
...
<div class="blank5"></div>
 ...
 <div class="box_1">
  ...
  <a href="category.php?category=5&display=grid&brand=0&price_min=300&price_max=1000&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/default/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=5&display=grid&brand=0&price_min=300&price_max=1000&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/default/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=5&display=grid&brand=0&price_min=300&price_max=1000&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/default/images/last_update_default.gif" alt="按更新时间排序"></a>
  <input type="hidden" name="category" value="5" />
  <input type="hidden" name="display" value="grid" id="display" />
  <input type="hidden" name="brand" value="0" />
  <input type="hidden" name="price_min" value="300" />
